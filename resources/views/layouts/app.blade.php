    ...
    <header class="main-header">
        <div class="container">
            <a href="{{ route('home') }}" class="logo">
                <img src="{{ asset('Images/logo.png') }}" alt="2IBSN Logo" class="logo-img" loading="eager" width="60"
                    height="60">
                <div class="logo-text">
            ...
            <nav class="main-nav">
                <ul class="nav-list">
                    ...
                    <li><a href="{{ route('programs') }}"
                            class="{{ request()->routeIs('programs') ? 'active' : '' }}">Programmes</a></li>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col">
                    <img src="{{ asset('Images/logo2.png') }}" alt="2IBSN Logo" class="footer-logo" loading="lazy"
                        width="80" height="80">
                ...
                <div class="footer-col">
                    <h3>Contact</h3>
                    <p>contact@2ibsn.edu.sn</p>
                    <!-- Placeholder email if not provided, used user provided one in reality but putting typo free one here or using the one provided -->
