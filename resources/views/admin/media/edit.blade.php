...
<div class="card">
    ...
    <div style="margin-bottom: 1.5rem; text-align: center;">
        <img src="{{ asset('storage/' . $medium->file_path) }}" alt="{{ $medium->title }}" style="max-width: 300px; max-height: 300px; border-radius: 8px;">
    </div>
    ...
    <form action="{{ route('admin.media.update', $medium) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" id="order" name="order" value="{{ old('order', $medium->order) }}" min="0">
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" value="{{ old('title', $medium->title) }}">
            @error('title')<span class="error">{{ $message }}</span>@enderror
        </div>
        
        <div class="form-group">
            <label for="description">Description</label>
            <textarea id="description" name="description" rows="3">{{ old('description', $medium->description) }}</textarea>
        ...
        <div style="display: flex; gap: 1rem; margin-top: 2rem;">
            ...
            <a href="{{ route('admin.appearance.gallery') }}" class="btn btn-secondary">Annuler</a>
        </div>
    </form>
</div>
