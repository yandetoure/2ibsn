...
@section('content')
<div class="card">
    <h2 style="margin-bottom: 1.5rem; color: var(--primary);">Modifier {{ $level->name }}</h2>
    ...
    <form action="{{ route('admin.levels.update', $level) }}" method="POST">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $level->name) }}" required placeholder="Ex: 6ème">
                    @error('name')<span class="error">{{ $message }}</span>@enderror
                </div>
                <div class="form-group">
                    <label for="code">Code <span style="color: #ef4444;">*</span></label>
                    <input type="text" id="code" name="code" value="{{ old('code', $level->code) }}" required placeholder="Ex: 6EME">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="category" name="category" required>
                        <option value="preschool" {{ old('category', $level->category) == 'preschool' ? 'selected' : '' }}>Préscolaire</option>
                        <option value="elementary" {{ old('category', $level->category) == 'elementary' ? 'selected' : '' }}>Élémentaire</option>
                        <option value="college" {{ old('category', $level->category) == 'college' ? 'selected' : '' }}>Collège</option>
                    </select>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="registration_fee" name="registration_fee" value="{{ old('registration_fee', $level->registration_fee) }}" min="0" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="monthly_fee" name="monthly_fee" value="{{ old('monthly_fee', $level->monthly_fee) }}" min="0" step="1" required>
        ...
        <div class="form-section" style="margin-top: 2rem;">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="half_pension_registration_fee" name="half_pension_registration_fee" value="{{ old('half_pension_registration_fee', $level->half_pension_registration_fee) }}" min="0" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="half_pension_monthly_fee" name="half_pension_monthly_fee" value="{{ old('half_pension_monthly_fee', $level->half_pension_monthly_fee) }}" min="0" step="1" required>
        ...
        <div style="display: flex; gap: 1rem; margin-top: 3rem;">
            <button type="submit" class="btn btn-primary" style="padding: 0.75rem 2rem;">Mettre à jour le Niveau</button>
